      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="max-w-[1600px] mx-auto flex flex-col gap-6">
          <div className="flex items-center justify-between">
            ...
            <Button><span className="material-symbols-outlined text-[18px] mr-1">note_add</span>Generate Report</Button>
          </div>
              ...
              <div className="divide-y divide-border">
                {scheduled.map((s) => (
                  <div key={s.name} className="flex items-center justify-between py-3">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-muted-foreground text-[20px]">schedule</span>
                      <div>
